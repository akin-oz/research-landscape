...
relationship_assertions:
  ...
  - predicate: develops
    ...
    confidence: high
    evidence_window: 2026-07
    notes: Spglib documentation names Togo among current main developers. This does not establish exclusive ownership, a complete maintainer roster, governance, review authority, or contribution frequency beyond that stated role.
---
...
| `SRC-SPGLIB-DOCUMENTATION` | [Spglib documentation](https://spglib.readthedocs.io/en/stable/) lists Atsushi Togo of the National Institute for Materials Science among current main developers. Accessed 2026-07-13. |
