...
The NequIP cluster adds [NequIP](research-software/nequip.md) and the [NequIP Ecosystem](ecosystems/nequip.md), while reusing controlled Python, AI for Materials, and Machine-Learned Potentials records. Its documented integrations remain prose context until a dependency relationship contract exists.
...
The Spglib cluster adds [Spglib](research-software/spglib.md), the [Spglib Ecosystem](ecosystems/spglib.md), and controlled [C](programming-languages/c.md), while reusing Atsushi Togo and Computational Materials Science. It makes no interface-dependency, group-wide-language, or complete-project-community claim.
...
The Research Problem catalog also includes [Materials Property Prediction](research-problems/materials-property-prediction.md), [Atomistic Molecular Dynamics Simulation](research-problems/atomistic-molecular-dynamics-simulation.md), [High-Throughput Materials Screening](research-problems/high-throughput-materials-screening.md), and [Atomistic Structure Optimization](research-problems/atomistic-structure-optimization.md). Each is a bounded computational challenge with direct, record-local software-support evidence; none is a project, benchmark, or problem-importance ranking.
