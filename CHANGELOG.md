...
- A bounded AiiDA development-team relation from Giovanni Pizzi to `aiida-core`, allowing open-source PI discovery without claiming maintainer authority, ownership, or ongoing contribution frequency.
