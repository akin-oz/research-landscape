...
The [AiiDA reference implementation](../../docs/reference-implementation.md), [Materials Project vertical slice](../../docs/materials-project-vertical-slice.md), and [OQMD–Wolverton vertical slice](../../docs/oqmd-wolverton-vertical-slice.md) now supply reviewed canonical entities for three software-ecosystem chains, including [AiiDA Ecosystem](../../entities/ecosystems/aiida.md), [Materials Project](../../entities/ecosystems/materials-project.md), and [OQMD](../../entities/ecosystems/oqmd.md). Materials Cloud, NOMAD, AFLOW, ASE, Quantum ESPRESSO, and LAMMPS material remain useful discovery trails until matching canonical entities are created; their source registers and dossiers retain their existing evidence boundaries.
