...
The [AiiDA reference implementation](../../docs/reference-implementation.md), [Materials Project vertical slice](../../docs/materials-project-vertical-slice.md), [OQMD–Wolverton vertical slice](../../docs/oqmd-wolverton-vertical-slice.md), [AFLOW–Curtarolo vertical slice](../../docs/aflow-curtarolo-vertical-slice.md), [Materialyze.AI–NUS vertical slice](../../docs/materialyze-ai-vertical-slice.md), [THEOS–EPFL / Materials Cloud vertical slice](../../docs/theos-vertical-slice.md), and [FAIRmat–Draxl vertical slice](../../docs/fairmat-draxl-vertical-slice.md) now supply reviewed canonical entities across seven software-ecosystem chains. ASE, Quantum ESPRESSO, and LAMMPS material remain useful discovery trails until matching canonical entities are created; their source registers and dossiers retain their existing evidence boundaries.
