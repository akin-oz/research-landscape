...
The [AiiDA reference implementation](../../docs/reference-implementation.md), [Materials Project vertical slice](../../docs/materials-project-vertical-slice.md), [OQMD–Wolverton vertical slice](../../docs/oqmd-wolverton-vertical-slice.md), and [AFLOW–Curtarolo vertical slice](../../docs/aflow-curtarolo-vertical-slice.md) now supply reviewed canonical entities for four software-ecosystem chains, including [AiiDA Ecosystem](../../entities/ecosystems/aiida.md), [Materials Project](../../entities/ecosystems/materials-project.md), [OQMD](../../entities/ecosystems/oqmd.md), and [AFLOW](../../entities/ecosystems/aflow.md). Materials Cloud, NOMAD, ASE, Quantum ESPRESSO, and LAMMPS material remain useful discovery trails until matching canonical entities are created; their source registers and dossiers retain their existing evidence boundaries.
