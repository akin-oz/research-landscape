...
Useful software facets are license, language, repository URL, release activity, documentation, governance, research area, ecosystem, maintainer group, and host institution. The reviewed [aiida-core](../../entities/research-software/aiida-core.md) and [pymatgen](../../entities/research-software/pymatgen.md) records are reference canonical software nodes; their reachability is documented in the [AiiDA reference implementation](../../docs/reference-implementation.md) and [Materials Project vertical slice](../../docs/materials-project-vertical-slice.md). Materials Cloud, NOMAD, AFLOW, ASE, Quantum ESPRESSO, and LAMMPS remain evidence trails until matching canonical records are created.
