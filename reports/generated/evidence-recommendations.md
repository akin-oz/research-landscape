...
<!-- input-fingerprint: c0990178cde80253e654a844a17d894c25367691c082b0f604cc9e32416e9427 -->
...
**Query ID:** `groups-scientific-software`

**Status:** available — evidence-discovery result, not a ranking.

| Candidate | Documented matching evidence | Confidence | Coverage |
| --- | --- | --- | --- |
| [Computational Atomic-scale Materials Design (CAMD)](../../entities/research-groups/dtu-camd.md) (`RG-DTU-CAMD`) | develops `SW-ASE` (sources: SRC-DTU-CAMD-RESEARCH); develops `SW-GPAW` (sources: SRC-DTU-CAMD-RESEARCH) | high | 1/1 documented criteria |
...
**Query ID:** `groups-computational-materials`
...
| [Computational Materials Science Group](../../entities/research-groups/nims-computational-materials-science-group.md) (`RG-NIMS-COMPUTATIONAL-MATERIALS-SCIENCE`) | works on `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-NIMS-TOGO-PROFILE, SRC-NIMS-PHONOPY-FEATURE) | high | 1/1 documented criteria |
...
**Query ID:** `groups-materials-informatics`
...
**Query ID:** `groups-open-software`

**Status:** available — evidence-discovery result, not a ranking.

| Candidate | Documented matching evidence | Confidence | Coverage |
| --- | --- | --- | --- |
| [Computational Atomic-scale Materials Design (CAMD)](../../entities/research-groups/dtu-camd.md) (`RG-DTU-CAMD`) | develops licensed open-source `SW-ASE` (sources: SRC-DTU-CAMD-RESEARCH); develops licensed open-source `SW-GPAW` (sources: SRC-DTU-CAMD-RESEARCH) | high | 1/1 documented criteria |
...
## Research groups with direct software-development and target-area evidence

**Query ID:** `environments-for-experienced-software-engineers`

**Status:** available — evidence-discovery result, not a ranking.

| Candidate | Documented matching evidence | Confidence | Coverage |
| --- | --- | --- | --- |
| [Computational Atomic-scale Materials Design (CAMD)](../../entities/research-groups/dtu-camd.md) (`RG-DTU-CAMD`) | develops `SW-ASE` (sources: SRC-DTU-CAMD-RESEARCH); develops `SW-GPAW` (sources: SRC-DTU-CAMD-RESEARCH); works on `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-DTU-CAMD-RESEARCH) | high | 2/2 documented criteria |
...
**Query ID:** `ecosystems-computational-materials`
...
| [AFLOW](../../entities/ecosystems/aflow.md) (`ECO-AFLOW`) | connects `PI-STEFANO-CURTAROLO` (sources: SRC-AFLOW-DOCUMENTATION); `PI-STEFANO-CURTAROLO` works on `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-DUKE-CURTAROLO-PROFILE); includes `SW-AFLOW` (sources: SRC-AFLOW-REPOSITORY); `SW-AFLOW` is classified in `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-AFLOW-DOCUMENTATION, SRC-AFLOW-REPOSITORY, SRC-AFLOW-INSTALLATION, SRC-AFLOW-API, SRC-AFLOW-2023-PUBLICATION) | high | 2/2 documented criteria |
...
| [GPAW Ecosystem](../../entities/ecosystems/gpaw.md) (`ECO-GPAW`) | connects `RG-DTU-CAMD` (sources: SRC-DTU-CAMD-RESEARCH); `RG-DTU-CAMD` works on `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-DTU-CAMD-RESEARCH); includes `SW-GPAW` (sources: SRC-GPAW-DOCUMENTATION); `SW-GPAW` is classified in `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-GPAW-DOCUMENTATION, SRC-GPAW-INSTALLATION, SRC-GPAW-LICENSE) | high | 2/2 documented criteria |
...
| [MatML Ecosystem](../../entities/ecosystems/matml.md) (`ECO-MATML`) | includes `SW-MATGL` (sources: SRC-MATGL-REPOSITORY); `SW-MATGL` is classified in `AREA-MATERIALS-INFORMATICS` (sources: SRC-MATGL-REPOSITORY, SRC-MATERIALYZE-SOFTWARE, SRC-MATGL-DOCUMENTATION) | high | 2/2 documented criteria |
...
| [MatML Ecosystem](../../entities/ecosystems/matml.md) (`ECO-MATML`) | includes `SW-MATGL` (sources: SRC-MATGL-REPOSITORY); `SW-MATGL` is classified in `AREA-AI-FOR-MATERIALS` (sources: SRC-MATGL-REPOSITORY, SRC-MATERIALYZE-SOFTWARE, SRC-MATGL-DOCUMENTATION) | high | 2/2 documented criteria |
...
| [MatML Ecosystem](../../entities/ecosystems/matml.md) (`ECO-MATML`) | includes `SW-MATGL` (sources: SRC-MATGL-REPOSITORY); `SW-MATGL` is classified in `AREA-MACHINE-LEARNED-POTENTIALS` (sources: SRC-MATGL-REPOSITORY, SRC-MATERIALYZE-SOFTWARE, SRC-MATGL-DOCUMENTATION) | high | 2/2 documented criteria |
...
| [Atsushi Togo](../../entities/principal-investigators/atsushi-togo.md) (`PI-ATSUSHI-TOGO`) | works on `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-NIMS-TOGO-PROFILE, SRC-NIMS-PHONOPY-FEATURE) | high | 1/1 documented criteria |
...
| [Ellad Tadmor](../../entities/principal-investigators/ellad-tadmor.md) (`PI-ELLAD-TADMOR`) | works on `AREA-COMPUTATIONAL-MATERIALS-SCIENCE` (sources: SRC-UMN-TADMOR-PROFILE) | high | 1/1 documented criteria |
...
**Query ID:** `principal-investigators-materials-informatics`
...
| Candidate | Documented matching evidence | Confidence | Coverage |
| --- | --- | --- | --- |
| [Computational Atomic-scale Materials Design (CAMD)](../../entities/research-groups/dtu-camd.md) (`RG-DTU-CAMD`) | develops `SW-ASE` (sources: SRC-DTU-CAMD-RESEARCH); `SW-ASE` is implemented in `PROGRAMMING-LANGUAGE-PYTHON` (sources: SRC-ASE-DOCUMENTATION); develops `SW-GPAW` (sources: SRC-DTU-CAMD-RESEARCH); `SW-GPAW` is implemented in `PROGRAMMING-LANGUAGE-PYTHON` (sources: SRC-GPAW-DOCUMENTATION, SRC-GPAW-INSTALLATION) | high | 2/2 documented criteria |
...
| Candidate | Documented matching evidence | Confidence | Coverage |
| --- | --- | --- | --- |
| [Hacking Materials](../../entities/research-groups/hacking-materials.md) (`RG-HACKING-MATERIALS`) | documents `onboarding-training` for Hacking Materials group handbook; limitation: Documents stated onboarding and guidance only; it does not establish current practice, individual support quality, availability, or outcomes. (sources: SRC-HACKING-MATERIALS-HANDBOOK); documents `professional-development` for Hacking Materials group handbook research-writing and presentation guidance; limitation: Documents stated writing and presentation guidance only; it does not establish current practice, individual development outcomes, mentoring quality, or career results. (sources: SRC-HACKING-MATERIALS-HANDBOOK) | medium | 1/1 documented criteria |
| [Materialyze.AI Lab](../../entities/research-groups/materialyze-ai-lab.md) (`RG-MATERIALYZE-AI`) | documents `supervision-process` for Materialyze.AI Lab public postdoctoral/PhD application process; limitation: States onboarding and mentorship practices in a public process post; it does not establish supervision capacity, current availability, effectiveness, or outcomes. (sources: SRC-MATERIALYZE-JOIN-US) | medium | 1/1 documented criteria |
...
**Query ID:** `high-mentorship-environments`
